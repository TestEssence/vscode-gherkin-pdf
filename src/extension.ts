 ...
 */
function convertMarkdownToHtml({ filename, type, text }: { filename: any; type: string; text: string; }) {
...
function downloadChromium(browserFetcher: any, revisionInfo: any, StatusbarMessageTimeout: Number) {
